...
<h4 style="font-size:2em; margin-top: -20px;">Aquí se abordarán únicamente aspectos referidos a las pilas de uso doméstico (*)</h4>  
...
<h4 style="font-size:2em; margin-top: -20px;">COMPARÁ PILAS Y BATERÍAS</h4>  

![comparapilas](/assets/images/post/15comparapilas.png)  

| Compará Pilas | Cilíndricas | Botón |  
|----------|----------|----------|  
| <form action="https://docs.google.com/document/d/19gSvhjZ_xcbocrw7rgooecc3-O9S3JPD__icZH-i6cE/edit?usp=sharing">
    <button type="submit">VER</button>  | <form action="https://docs.google.com/document/d/19gSvhjZ_xcbocrw7rgooecc3-O9S3JPD__icZH-i6cE/edit?usp=sharing">
    <button type="submit">VER</button>   |  <form action="https://docs.google.com/document/d/19gSvhjZ_xcbocrw7rgooecc3-O9S3JPD__icZH-i6cE/edit?usp=sharing">
    <button type="submit">VER</button>  |  

<!--section-->  

<h4 style="font-size:2em; margin-top: -20px;">Efectos sobre la salud y el ambiente de algunos componentes de las pilas</h4>  
...
_Según sus componentes_ las pilas y baterías presentan un riesgo ambiental _potencial_ desde su ***fabricación, uso y tratamiento*** como residuo. El grado de toxicidad es diferente de acuerdo a cada tipo.  
...
***
<h4 style="font-size:2em; margin-top: -20px;">ATENCIÓN</h4>  
...
<h4 style="font-size:2em; margin-top: -20px;">Tipos de tratamiento más habituales existentes en el mundo para pilas y baterías usadas</h4>  


***

<h4 style="font-size:2em; margin-top: -20px;">Países que cuentan con capacidad industrial para el reciclado y tratamiento de pilas y baterías usadas. Ejemplos.</h4>  
...
<h4 style="font-size:2em; margin-top: -20px;">Abanico o baraja de opciones que existen al momento de elegir pilas y baterías o un sustituto.</h4>  

Se presentan ordenadas según relevancia y beneficio o aceptabilidad (+ / - )

***

<h5 style="font-size:2em; margin-top: -20px;">¿Qué sucede en los hechos en Argentina?</h5>  

***

<h4 style="font-size:2em; margin-top: -20px;">Matriz Legal</h4>  


***

<h4 style="font-size:2em; margin-top: -20px;">¿Qué clase de residuo son las pilas usadas?</h4>  
...
<h4 style="font-size:2em; margin-top: -20px;">¿Cómo se gestionan en la práctica?</h4>  


***

<h4 style="font-size:2em; margin-top: -20px;">Proyectos de reciclado en etapa de investigación existentes en Argentina</h4>  

***

<h4 style="font-size:2em; margin-top: -20px;">Preguntas Frecuentes</h4>  

***

<h4 style="font-size:2em; margin-top: -20px;">Jurisdicciones con municipios que informan que gestionan y tratan pilas usadas en Argentina</h4>
...
<h4 style="font-size:2em; margin-top: -20px;">Enlaces de Referencia</h4>  

+ enlace
+ enlace

<h4 style="font-size:2em; margin-top: -20px;">Créditos</h4>  
...
<h4 style="font-size:2em; margin-top: -20px;">Agradecimientos</h4>  

- DC, CIAT, Tafí Viejo, Tucumán, Argentina
- INTI


<h4 style="font-size:2em; margin-top: -20px;">Cita</h4>  
...
<h4 style="font-size:2em; margin-top: -20px;">Licencia</h4>  
